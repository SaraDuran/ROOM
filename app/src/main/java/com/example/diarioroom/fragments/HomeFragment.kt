...
import com.example.diarioroom.adapter.DiarioAdapter
import com.example.diarioroom.databinding.FragmentHomeBinding
...
class HomeFragment : Fragment(R.layout.fragment_home), SearchView.OnQueryTextListener, MenuProvider {
    ...
    private lateinit var darioAdapter: DiarioAdapter
...
//    }
    ...
    private fun setupHomeRecyclerView(){
        ...
        activity?.let {
            diarioViewModel.getAllNotes().observe(viewLifecycleOwner){ note ->
                diarioAdapter.differ.submitList(note)
                updateUI(note)
            }
        }
    }
    ...
    private fun searchNote(query: String?){
        ...
        diarioViewModel.searchNote(searchQuery).observe(this) {list ->
            diarioAdapter.differ.submitList(list)
        }
    }
